...
#| echo: false
library(readxl)
Car <- read_excel("C:/Users/usuaria/OneDrive/Escritorio/DISEÑO/RLM/Car.xlsx")
View(Car)
...
### 1.n auto que ha recorrido una mayor distancia en menos años puede tener un precio más bajo en comparación con otro que ha recorrido la misma distancia pero en más años.
