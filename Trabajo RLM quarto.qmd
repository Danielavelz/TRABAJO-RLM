...
Es importante destacar que el modelo "m9" que elegimos de regresión lineal múltiple desarrollado presenta limitaciones. Aunque identifica variables significativas, no satisface todos los criterios de validación necesarios para garantizar su precisión en futuras predicciones. Por lo tanto, se recomienda utilizar este modelo con precaución y considerar otros enfoques o técnicas de modelado para mejorar la precisión en futuras investigaciones.
